...
<body>
    ...
    <nav class="navbar navbar-expand-md fixed-top navbar-light border-bottom">
      <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarToggleContent">
          <ul class="navbar-nav">
              ...
              @guest
              <li><a class="nav-link btn btn-outline-success mx-1" href="{{ route('login') }}"><i class="fas fa-user-plus"></i>{{ __('Signin') }}</a></li>
              <li><a class="nav-link btn btn-outline-primary" href="{{ route('register') }}"><i class="fas fa-sign-in-alt"></i>{{ __('Signup') }}</a></li>
          @else
              ...
              <div class="row justify-content-between">
                <div class="col-md-3">
                  <a class="navbar-brand " href="#">
                    <i class="fas fa-leaf text-muted"></i> <span class="text-muted">{{ config('app.name', 'Laravel') }}</span>
                  </a>
                </div>
